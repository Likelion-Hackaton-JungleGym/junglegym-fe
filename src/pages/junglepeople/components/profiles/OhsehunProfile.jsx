...
import SeoulMayor from "./img/SeoulMayor.svg";
import RedParty from "./img/RedParty.svg";
import TooltipImg from "./img/TooltipButton.svg";

export default function OhsehunoProfile() {
  const [showTooltip, setShowTooltip] = useState(false);
  const toggleTooltip = () => setShowTooltip((prev) => !prev);

  return (
    <Wrapper>
      <ProfileImg src={ohsehun} />
      <Name>오세훈</Name>
      <PartyImg src={RedParty} />
      <PositionWrapper>
        <PositionImg src={SeoulMayor} />
        <TooltipWrapper>
